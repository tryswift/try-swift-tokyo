  ...
  private var workshopSeeds: [WorkshopSeed] {
    [
      WorkshopSeed(
        ...
        titleJA: nil,
        abstract: "Metal shaders unlock a level of visual expression in SwiftUI that goes far beyond built-in modifiers, but they are often perceived as complex, low-level, or hard to approach. This workshop is designed to make Metal shaders accessible, visual, and fun for SwiftUI developers, even for those with no prior graphics or Metal experience.",
        abstractJA: nil,
        talkDetail: """
        ...
        speaker: SpeakerSeed(
          ...
          bio: "iOS developer with around 10 years of experience across startups and large companies. Co-founder and CEO of Panels, a digital comics reading app, with a background rooted in UI, interaction, and animation.",
          bioJa: nil,
          organization: "Panels",
          avatarURL: nil
        ),
        details: WorkshopDetails(
          language: .english,
          numberOfTutors: 1,
          keyTakeaways: "A clear mental model of how Metal shaders work in SwiftUI. Ability to design shader effects visually before writing code. Practical experience integrating shaders using modern SwiftUI APIs. Understanding of common pitfalls and performance considerations. Confidence to experiment and create original visual effects.",
          prerequisites: "Basic Swift knowledge (around one year recommended), plus basic familiarity with SwiftUI and iOS or macOS development. No prior Metal or graphics programming experience is required.",
          agendaSchedule: "0:00-0:15 introduction to shader concepts and SwiftUI APIs. 0:15-1:15 visual exploration with MetalGraph. 1:25-1:55 translating node graphs into Metal shader code. 1:55-2:25 integrating shaders into SwiftUI and iterating on effects. 2:25-2:30 wrap-up and Q&A.",
          participantRequirements: "Bring a MacBook. An iPad is also useful for the MetalGraph portion. Workshop licenses will be provided to attendees.",
          requiredSoftware: "Latest version of Xcode with the Metal toolchain enabled, plus MetalGraph (free version is fine; licenses will be provided).",
          networkRequirements: "None.",
          motivation: "This workshop gives SwiftUI developers a practical path into custom visual effects without requiring prior graphics programming experience.",
          uniqueness: "It combines a visual-first workflow with direct translation into production SwiftUI and Metal code.",
          potentialRisks: nil
        ),
        detailsJA: nil,
        coInstructors: nil
      ...
      WorkshopSeed(
        ...
        details: WorkshopDetails(
          language: .bilingual,
          numberOfTutors: 2,
          keyTakeaways: "Understand what the Foundation Models framework is, how it works inside a project, how to combine it with frameworks like Vision or Speech, and how to work effectively within the limits of on-device models.",
          prerequisites: "Basic knowledge of iOS development.",
          agendaSchedule: "0:00-0:20 introduction to the Foundation Models framework. 0:20-0:40 project setup and sample app overview. 0:40-2:30 hands-on challenges with guided explanations and reference implementations.",
          participantRequirements: "Bring a MacBook, MacBook Pro, or Mac mini/studio with a display. An iPhone or iPad is optional.",
          requiredSoftware: "Xcode 26.0 or later on macOS 26 Tahoe. This setup does not work on earlier macOS releases such as Sequoia or Sonoma.",
          networkRequirements: "No ongoing network requirement, but attendees need access to download sample projects from Box.",
          motivation: "This workshop helps developers get practical, hands-on experience with Apple's newest on-device model APIs.",
          uniqueness: "It blends prompt design, tool calling, localization, and multimodal framework integration in one guided session.",
          potentialRisks: "The original material was designed for a longer format, so pacing may need to be adjusted during delivery."
        ),
        detailsJA: nil,
        coInstructors: [
          CoInstructor(
      ...
      WorkshopSeed(
        ...
        titleJA: nil,
        abstract: "This workshop will teach a range of techniques to increase the performance of Swift apps. Participants will use Instruments to identify performance issues, work through fixes, and verify the improvements with performance tests and follow-up profiling.",
        abstractJA: nil,
        talkDetail: """
        ...
        speaker: SpeakerSeed(
          ...
          bio: "Author of Hacking with Swift, Pro Swift, Swift Design Patterns, Testing Swift, Swift Interview Challenges, and more. He enjoys teaching Swift almost as much as coffee.",
          bioJa: nil,
        ...
        details: WorkshopDetails(
          language: .english,
          numberOfTutors: 1,
          keyTakeaways: "Identify performance hotspots with Instruments, write reusable fixes for common bottlenecks, and create performance tests so regressions do not return.",
          prerequisites: "This workshop is aimed at intermediate to advanced Swift and SwiftUI developers and is not suitable for complete beginners.",
          agendaSchedule: "The session is organized around five 25-minute topics: memoization, concurrency, SwiftUI, Observation, and leaks. Each block covers profiling, testing, explaining a solution, and applying it to the sample project, with additional time for intro and wrap-up.",
          participantRequirements: "Bring a laptop and an iPhone. A USB-C cable is recommended for faster debugging against a device.",
          requiredSoftware: "Xcode 26 with the iOS 26 SDK.",
          networkRequirements: "Attendees need to download the sample project, but there are otherwise no special network requirements.",
          motivation: "Performance work is often abstract; this workshop turns it into a repeatable, tool-driven workflow developers can apply immediately.",
          uniqueness: "The session is structured around repeated profiling and remediation loops, which makes the improvement process concrete and measurable.",
          potentialRisks: nil
        ),
        detailsJA: nil,
        coInstructors: nil
      ...
      WorkshopSeed(
        ...
        titleJA: nil,
        abstract: "This experimental workshop temporarily sets aside the App Store Review Guidelines to peek inside the iOS black box. By deliberately using private APIs and undocumented behaviors, participants will gain a deeper understanding of how UIKit and SwiftUI operate under the hood.",
        abstractJA: nil,
        talkDetail: """
        ...
        details: WorkshopDetails(
          language: .japanese,
          numberOfTutors: 2,
          keyTakeaways: "Learn how to access dynamic functionality from Swift via Objective-C Runtime, inspect view hierarchies and internal component structure, investigate undocumented APIs, and understand the risks of fragile implementations across OS updates.",
          prerequisites: "Basic Swift and iOS development knowledge, basic Git/GitHub operations such as clone, pull, and push, and curiosity about Objective-C Runtime.",
          agendaSchedule: "0:00-0:20 intro, environment setup, and repository sharing. 0:20-0:50 lecture and demo. 0:50-1:25 hands-on part 1. 1:25-1:35 intermediate review. 1:35-2:10 hands-on part 2. 2:10-2:30 wrap-up and sharing.",
          participantRequirements: "Bring a Mac with Xcode. An iPhone device is optional; the simulator is acceptable. A GitHub account is optional.",
          requiredSoftware: "Xcode.",
          networkRequirements: "No extra external API access is required and no VPN is needed.",
          motivation: "Understanding the unsupported edges of the platform helps developers better understand the supported ones too.",
          uniqueness: "It treats private APIs as a learning tool for system internals rather than a production recommendation.",
          potentialRisks: "Examples intentionally cover brittle techniques that should not be used in App Store production apps."
        ),
        detailsJA: WorkshopDetailsJA(
          keyTakeaways: "Objective-C Runtimeを用いたSwiftからの動的な機能アクセスの方法、View Hierarchyの解析手法と標準コンポーネント内部へのアクセス、ドキュメントに記載されていないAPIやクラスの調査テクニック、OSアップデートで壊れうる脆い実装の実例を学びます。",
          prerequisites: "SwiftおよびiOS開発の基礎知識、Git/GitHubの基本操作、Objective-C Runtimeへの興味がある方を対象にしています。",
          agendaSchedule: "0:00-0:20 導入と環境構築。0:20-0:50 講義とデモ。0:50-1:25 ハンズオン前半。1:25-1:35 中間レビュー。1:35-2:10 ハンズオン後半。2:10-2:30 成果発表とクロージング。",
      ...
      WorkshopSeed(
        ...
        titleJA: nil,
        abstract: "Allow users to discover and more quickly access all that your app can do, sometimes without even opening your app. This workshop demonstrates how to use App Intents to expose app functionality through Shortcuts, Spotlight, Siri, Widgets, and Controls.",
        abstractJA: nil,
        talkDetail: """
        ...
        speaker: SpeakerSeed(
          ...
          bio: "Author of more than a dozen books including The Curious Case of the Async Cafe, A SwiftUI Kickstart, and A Swift Kickstart. Daniel teaches iOS, SwiftUI, and Swift through training and consulting at Dim Sum Thinking.",
          bioJa: nil,
        ...
        details: WorkshopDetails(
          language: .english,
          numberOfTutors: 1,
          keyTakeaways: "Understand how App Intents help users discover app functionality through system surfaces such as Shortcuts, Spotlight, Siri, Widgets, and Controls.",
          prerequisites: nil,
          agendaSchedule: "N/A",
          participantRequirements: "N/A",
          requiredSoftware: nil,
          networkRequirements: "N/A",
          motivation: "App Intents are becoming a central integration point for modern Apple platforms and deserve hands-on exploration.",
          uniqueness: "The session focuses on practical exposure of app functionality across multiple system entry points.",
          potentialRisks: nil
        ),
        detailsJA: nil,
        coInstructors: nil
