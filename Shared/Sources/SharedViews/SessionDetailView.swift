    ...
    NavigationStack {
        SessionDetailView(
            session: Session(
                ...
                place: "Main Hall",
                description: "In this session, we'll explore how Skip enables you to write SwiftUI code that runs on both iOS and Android. You'll learn about the architecture, limitations, and best practices.",
